...
internal class GHGameAssetManager
{
    ...
    private Dictionary<GameAnimationName, GHGameAnimationEntry> _animations = new();
    private Dictionary<GameSoundName, GHGameSoundEntry> _sounds = new();
    ...
    {
        /* Planet. */
        _animations.Add(GameAnimationName.Planet_Atmosphere_Default, new(0f, Origin.Center, "game/planets/atmosphere/default"));

        _animations.Add(GameAnimationName.Planet_GasSurface_1,  new(
            0f, Origin.Center, "game/planets/layers/gassurface1"));

        _animations.Add(GameAnimationName.Planet_GasOverlay_1, new(
            0f, Origin.Center, "game/planets/layers/gasoverlay1"));

        _animations.Add(GameAnimationName.Planet_GasOverlay_2, new(
            0f, Origin.Center, "game/planets/layers/gasoverlay2"));

        _animations.Add(GameAnimationName.Planet_RockSurface_1, new(
            0f, Origin.Center, "game/planets/layers/rocksurface1"));

        _animations.Add(GameAnimationName.Planet_WaterSurface_1, new(
            0f, Origin.Center, "game/planets/layers/watersurface"));

        _animations.Add(GameAnimationName.Planet_Clouds_1, new(
            0f, Origin.Center, "game/planets/layers/clouds1"));

        _animations.Add(GameAnimationName.Planet_Clouds_2, new(
            0f, Origin.Center, "game/planets/layers/clouds2"));

        _animations.Add(GameAnimationName.Planet_Clouds_3, new(
            0f, Origin.Center, "game/planets/layers/clouds3"));

        _animations.Add(GameAnimationName.Planet_Clouds_4, new(
            0f, Origin.Center, "game/planets/layers/clouds4"));

        _animations.Add(GameAnimationName.Planet_Clouds_5, new(
            0f, Origin.Center, "game/planets/layers/clouds5"));  


        /* Particles. */
        _animations.Add(GameAnimationName.Particle_Test, new(
        ...
        /* Background. */
        _animations.Add(GameAnimationName.Background_Default, new(
            0f, Origin.TopLeft, GameBackground.ASSETPATH_BACKGROUND_DEFAULT));

        _animations.Add(GameAnimationName.Background_Star_Small, new(
            0f, Origin.Center, GameBackground.ASSETPATH_STAR_SMALL));

        _animations.Add(GameAnimationName.Background_Star_Medium, new(
            0f, Origin.Center, GameBackground.ASSETPATH_STAR_MEDIUM));

        _animations.Add(GameAnimationName.Background_Star_Big, new(
            0f, Origin.Center, GameBackground.ASSETPATH_STAR_BIG));


        /* Ships. */
        /* Probe. */
        _animations.Add(GameAnimationName.Ship_Probe_Base, new(
            0f, Origin.Center, "game/ships/probe/base"));

        _animations.Add(GameAnimationName.Ship_Probe_Head, new(
            0f, Origin.Center, "game/ships/probe/head"));

        _animations.Add(GameAnimationName.Ship_Probe_MainThruster, new(
            0f, Origin.Center, "game/ships/probe/main_thruster"));

        _animations.Add(GameAnimationName.Ship_Probe_SideThruster,new (
            0f, Origin.Center, "game/ships/probe/side_thruster"));

        _animations.Add(GameAnimationName.Ship_Probe_RollPanel, new(
            0f, Origin.Center, "game/ships/probe/roll_panel"));

        _animations.Add(GameAnimationName.Ship_Probe_RollPanelIndicator, new(
           0f, Origin.Center, "game/ships/probe/roll_panel_indicator"));

        _animations.Add(GameAnimationName.Ship_Probe_ThrusterPanel, new(
           0f, Origin.Center, "game/ships/probe/thruster_panel"));

        _animations.Add(GameAnimationName.Ship_Probe_ThrusterPanelButton, new(
