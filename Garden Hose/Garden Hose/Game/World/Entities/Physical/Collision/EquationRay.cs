...
internal struct EquationRay
{
    ...
    // Constructors.
    internal EquationRay(float xOffset, float xStep) : this(xOffset, xStep, 0f) { }

    internal EquationRay(float xOffset, float xStep, float originX)
    {
        YOffset = xOffset;
        YStep = xStep;
        OriginX = originX;
    ...
    internal EquationRay(Vector2 lineStart, Vector2 lineEnd)
    {
        OriginX = lineStart.X;
    ...
    internal EquationRay(Edge edge) : this(edge.StartVertex, edge.EndVertex) { }


    // Internal static methods.
    internal static Vector2? GetIntersection(EquationRay ray1, EquationRay ray2)
    {
        if (ray1 == ray2)
        {
    ...
    {
        if (obj is not EquationRay)
        {
            return false;
        }

        return this == (EquationRay)obj;
    }
    ...
    // Operators.
    public static bool operator ==(EquationRay ray1, EquationRay ray2)
    {
