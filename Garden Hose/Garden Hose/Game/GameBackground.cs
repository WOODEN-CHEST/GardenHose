...
internal class GameBackground : IDrawableItem
{
    ...
    internal GHGameAnimationName Image { get; init; }
    ...
    // Constructors.
    public GameBackground(GHGameAnimationName image)
    {
        Image = image;
    }
    ...
    internal void Load(GHGameAssetManager assetManager)
    {
        ...
        {
            GHGameAnimationName.Background_Default => new(assetManager.GetAnimation(GHGameAnimationName.Background_Default)!.CreateInstance()),
    ...
    internal void Load(IGameFrame? owner)
    {
        ...
        _background = Image switch
        {
            GHGameAnimationName.Background_Default => new(new SpriteAnimation(0f, owner, Origin.TopLeft, 
    ...
    public void Draw(IDrawInfo info)
    {
        ...
        string a = AssetManager.BasePath;
