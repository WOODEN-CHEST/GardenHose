...
public class PositionalItem : IDrawableItem
{
    ...
    public virtual Vector2 Position
    {
        ...
        set
        {
            ...
            if (IsPositionScaledX) RealPosition.X = (RealPosition.X) * Display.ItemScale;
            if (IsPositionScaledY) RealPosition.Y = (RealPosition.Y) * Display.ItemScale;

            if (IsPositionOffsetX) RealPosition.X += Display.XOffset;
            if (IsPositionOffsetY) RealPosition.Y += Display.YOffset;
        }
    }
    ...
    public virtual Vector2 Scale
    {
        ...
        set
        {
            ...
            if (IsSizeRelative) RealScale *= Display.ItemScale;
        }
    }
    ...
    // Constructors.
    public PositionalItem() => Display.DisplayChanged += OnDisplayChange;
